...
- teste directement la dernière version du jeu ;
...
Publie simplement tous les fichiers sur un serveur web ou GitHub Pages. Tant que `config.js` ne contient pas de paramètres Supabase, le site fonctionne en **mode démo locale** avec `localStorage`.

Attention : dans ce mode, chaque navigateur possède son propre historique. Ce mode sert uniquement à tester l'interface.

## 2. Activer le vrai mode collaboratif
